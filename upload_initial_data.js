...
async function uploadAll() {
    ...
    if (selErr) {
        console.error('❌ Select failed. Table might really be missing or permissions issue.', selErr);
        // Continue anyway to see if upsert works
    } else {
        console.log('✅ Select succeeded. Table exists.');
    }
